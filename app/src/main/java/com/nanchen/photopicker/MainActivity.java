package com.nanchen.photopicker;
...
import com.nanchen.imagepicker.PhotoPickerActivity;
import com.nanchen.imagepicker.util.ImageLoader;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);int screenWidth = OtherUtils.getWidthInPx(getApplicationContext());
